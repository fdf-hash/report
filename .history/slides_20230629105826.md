...
```vue
 <el-table-select
  ...
  >
    <el-button type="primary">选择合同</el-button>
    <template #searcher>
      <el-form
        :data="formQuery"
        style="display: flex; flex-wrap: wrap; width: auto"
      >
        <el-input label="合同编号:" field="htbh" clearable />
        <el-input label="合同名称:" field="htmc" clearable />
        <el-input label="乙方名称:" field="yfmc" clearable />
        <el-input label="甲方名称:" field="jfmc" clearable />
        <el-form-item label="合同金额:">
          <el-range v-model:model-value="htjeold" clearable />
        </el-form-item>
        <el-form-item label="减免金额:">
          <el-range v-model:model-value="jmjeold" />
        </el-form-item>
      </el-form>
    </template>
    <template #action="{row, index}">
      <el-action-group>
        <el-action
          ...
          @run="handleDelete(row, index)"
          >删除
        </el-action>
        <el-action v-else @run="handleView(row)">详情</el-action>
      </el-action-group>
    </template>
  </el-table-select>
```
