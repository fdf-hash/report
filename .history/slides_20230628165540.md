...
- **罚没管理** - <span id="tooltip-trigger" style="position: relative;">维护和完善一些功能</span>
<br>
<br>

<div id="tooltip" style="position: absolute; z-index: 1; background-color: #000; color: #fff; padding: 5px; border-radius: 5px; font-size: 14px; display: none;"></div>

<script>
  var tooltipTrigger = document.getElementById('tooltip-trigger');
  ...
  tooltipTrigger.addEventListener('mouseenter', function() {
    tooltip.textContent = '对罚没进行管理、维护和完善相关功能';
